###########################################################################
# AUTHOR  : Black pregnancy <> Salvatore                                  #
#  TIP     : FUCK YOU HATERS						  #
###########################################################################
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢻⡿⠏⠘⠋⢠⡄⠘⠋⠹⢿⡟⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡆⠀⠀⠀⢸⢁⡀⠀⠐⠃⡆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢰⣷⡆⠀⠀⢸⡀⠀⠐⢴⣷⡆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀#! Disclaimer This Tools For Educational Purpose Only !!!⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢏⣿⡇⠀⠀⠀⠀⢸⣿⡏⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡆⠐⠒⠀⠐⠐⠂⣆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀#Black pregnancy
⠀⠀⠀⠀⠀⠀⠀⠀
#####################################
...
""")
        ...
        print("""
Hi.
My Name Salvatore  , A Ethical Hacker,Programming Tools ,Currently Working as Cyber Security Researcher.
